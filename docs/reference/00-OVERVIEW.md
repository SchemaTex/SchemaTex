...
| 🛡️ **Risk & reliability** | fault tree · bowtie · event tree · FMEA | NUREG-0492 / IEC 61025 fault tree — MOCUS minimal cut sets + P(top) (37-FAULT-TREE) · CCPS/EI 2018 bowtie — barrier-based threat→knot→consequence (38-BOWTIE) · IEC 62502 / NUREG event tree — engine computes path frequencies (39-EVENT-TREE) · AIAG-VDA / IEC 60812 FMEA — engine computes RPN = S×O×D + Action Priority (40-FMEA) |
