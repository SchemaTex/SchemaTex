...
| 🏠 **Architecture & Space** | floor plan / space layout · evacuation / escape plan | Architectural Graphic Standards + US NCS floor plans with shared-scale multi-floor plates, stair registration, poché walls, rect-union `extend`, openings, 99-symbol furniture, computed dimensions, and collision validation (48-FLOORPLAN-STANDARD) · ISO 23601 / ISO 7010 / ISO 3864, NFPA 170 Ch.11, and UAE Civil Defence evacuation plans with 40 renderable safety-sign variants, orthogonal chevron routes, mandatory Tier-M legend, layer switching, and computed sheet scale/sign size (53-EVACUATION-PLAN-STANDARD) |
