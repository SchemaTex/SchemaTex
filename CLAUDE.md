...
已完成：Genogram, Ecomap, Pedigree, Phylo, Sociogram, Timing, Logic Gate, Circuit, Block, Ladder, SLD, Entity Structure, Decision Tree, ERD (crow's-foot v0.1; Chen/Barker deferred), Breadboard (v0.1; Fritzing-style stylized parts catalog, smooth Bézier wires), BPMN (v0.1; pools/lanes/events/gateways/flows, OMG BPMN 2.0.2 visual subset)。
