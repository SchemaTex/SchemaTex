...
50 个 engine 全部支持安全的 authored 文字 / 字段编辑，其中 40 个还支持稳定 ID 拖拽或 native geometry handle。详见 [Interactive Editing 指南](https://schematex.js.org/docs/interactive-editing) 和 [在线测试 workspace](https://schematex.js.org/playground/interactive)。
