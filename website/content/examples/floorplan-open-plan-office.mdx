...
dsl: |
  ...
  grid desk-l in work rows 3 cols 6 count 18 centers 1.8,1.8 14.2,8.2 itemsize 1.6x1.6
...
Eighteen corner workstations come from one `grid desk-l` — each L-desk draws its own task chair, and the grid's `centers` coordinates are the centres of the first and last desk, so the 2.5 m column pitch leaves a clear circulation lane between rows.
