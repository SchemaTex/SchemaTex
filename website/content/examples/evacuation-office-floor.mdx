...
description: "A posted office escape plan with two structurally independent routes, final exits, fire equipment, first aid, a mandatory legend, and an ISO print-scale check."
diagram: evacuation
