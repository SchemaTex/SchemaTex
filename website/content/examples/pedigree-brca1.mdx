...
- `carrier` — key-defined diagonal hatch fill (NSGC Bennett 2022 §4.5); individual carries the mutation but is currently asymptomatic
- `presymptomatic` — edge-to-edge vertical line; positive genetic test but no clinical diagnosis yet
- `proband` — arrow with a P label; the individual who triggered clinical investigation
