...
dsl: |
  ...
  door salon south at 15% width 1.8 type double swing out
  ...
  grid salon-chair in salon rows 1 cols 4 count 4 centers 3.6,1.0 9.6,1.0 itemsize 0.8x1.4
  grid manicure-table in salon rows 1 cols 3 count 3 centers 4,5.4 9,5.4 itemsize 1x0.5
