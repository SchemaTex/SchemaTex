...
dsl: |
  ...
  door between dining kitchen at 20%
  ...
  row bar-stool in dining cols 5 centers 0.8,1.45 4.3,1.45
  furniture podium "Host" in dining at 0.7,8.2
  grid round-table-4 in dining rows 2 cols 3 centers 1.6,3.3 6.4,5.9 itemsize 1.9x1.9
