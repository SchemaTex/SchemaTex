...
|---|---|---|
| Retangular | `rectangular` | Ramos em formato L; raiz à esquerda, folhas à direita |
| Inclinado | `slanted` | Padrão. Linhas diagonais do pai para o filho; mais compacto |
...
|---|---|---|---|
| `layout:` | `rectangular`, `slanted`, `circular`, `unrooted` | `slanted` | Layout da árvore |
