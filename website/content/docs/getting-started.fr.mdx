...
→ Vous souhaitez créer vos propres fonctionnalités IA ? Consultez **[Utiliser Schematex avec l'IA](/docs/ai-integration)** — adaptateur Vercel AI SDK, huit outils et la boucle d'agent auto-correctif recommandée.
