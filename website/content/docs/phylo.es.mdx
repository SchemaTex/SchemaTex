...
|---|---|---|
| Rectangular | `rectangular` | Ramas en forma de L; raíz a la izquierda, puntas a la derecha |
| Inclinado | `slanted` | Predeterminado. Líneas diagonales de padre a hijo; más compacto |
...
|---|---|---|---|
| `layout:` | `rectangular`, `slanted`, `circular`, `unrooted` | `slanted` | Diseño del árbol |
