...
Double-click authored state or transition labels to edit their exact source ranges. Drag states only across the primary layout axis; transition progression remains semantic and connectors follow live.
