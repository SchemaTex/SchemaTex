...
→ ¿Quieres construir tus propias funciones de IA? Consulta **[Usar Schematex con IA](/docs/ai-integration)** — adaptador de Vercel AI SDK, ocho herramientas y el bucle de agente con autocorrección recomendado.
