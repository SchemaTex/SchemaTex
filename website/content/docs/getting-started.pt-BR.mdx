...
→ Quer construir suas próprias funcionalidades de IA? Veja **[Usando o Schematex com IA](/docs/ai-integration)** — adaptador do Vercel AI SDK, oito ferramentas e o loop de agente com autocorreção recomendado.
