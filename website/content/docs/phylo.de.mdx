...
|---|---|---|
| Rechteckig | `rectangular` | L-förmige Äste; Wurzel links, Blätter rechts |
| Geneigt | `slanted` | Standard. Diagonale Linien von Eltern zu Kindern; kompakter |
...
|---|---|---|---|
| `layout:` | `rectangular`, `slanted`, `circular`, `unrooted` | `slanted` | Baum-Layout |
