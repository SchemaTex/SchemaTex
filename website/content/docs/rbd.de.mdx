...
`theme: default` verwendet die gemeinsame Risk-&-Reliability-Palette (neutrale Blöcke, blaue Zuverlässigkeitszahlen, rote Single-Point-of-Failure-Ränder). `theme: monochrome` rendert eine Schwarz-Weiß-Druckversion (SPOF durch Randstärke); `theme: dark` ist die Schematex slate/blue-Dark-Variante.
