...
`default` est le bleu maison avec une valence vert/rouge/ambre ; `monochrome` supprime les couleurs (la valence repose sur ✓/✗/~, le gagnant sur une bordure épaisse) pour l'impression en noir et blanc ; `dark` est Schematex slate/blue.
