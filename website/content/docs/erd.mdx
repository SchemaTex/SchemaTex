...
The title, table aliases, column names, and data types expose independent source fields. Tables move only across relationship ranks; schema semantics own the primary layout axis and relationships reroute after every edit.
