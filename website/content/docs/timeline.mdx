...
The title is editable and movable. Native point and range-edge handles move horizontally and rewrite authored ISO dates; they never persist decorative canvas coordinates.
