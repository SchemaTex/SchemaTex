...
`default` ist das Haus-Blau mit grüner/roter/bernsteinfarbener Wertung; `monochrome` entfernt Farbe (die Wertung basiert auf ✓/✗/~, der Gewinner auf einem dicken Rahmen) für Schwarz-Weiß-Druck; `dark` ist Schematex slate/blue.
