...
The title is editable and movable. Places and transitions keep their automatic flow-layer order but move on the safe cross-axis; standard, inhibitor, read, and reset arcs remain attached.
