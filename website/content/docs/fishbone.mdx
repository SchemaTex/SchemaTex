...
Effect, category, cause, sub-cause text, and the title are editable. Bone geometry remains automatic because placement directly encodes the Ishikawa hierarchy.
