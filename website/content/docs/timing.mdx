...
The title is editable and movable. Native waveform-boundary handles resize adjacent states on the time axis and rewrite the literal wave token while signal-row order stays fixed.
