...
`default` es el azul de la casa con valencia verde/rojo/ámbar; `monochrome` elimina el color (la valencia se basa en ✓/✗/~, el ganador en un borde grueso) para impresión en blanco y negro; `dark` es Schematex slate/blue.
