...
|---|---|---|
| Rectangulaire | `rectangular` | Branches en L ; racine à gauche, feuilles à droite |
| Oblique | `slanted` | Par défaut. Lignes diagonales du parent à l'enfant ; plus compact |
...
|---|---|---|---|
| `layout:` | `rectangular`, `slanted`, `circular`, `unrooted` | `slanted` | Mise en page de l'arbre |
