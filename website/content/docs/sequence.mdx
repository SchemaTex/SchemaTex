...
Participant aliases, message labels, and the title are editable. Lifelines move horizontally; vertical message order remains source-defined because that axis represents time.
