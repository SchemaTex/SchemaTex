---
title: Introduction
description: Every diagram a doctor, engineer, or lawyer would actually use. Free. Fully open source. Made for AI. 29 industry-standard diagrams from a text DSL.
---
...
- [Playground](/playground) — try all 29 diagram types live
