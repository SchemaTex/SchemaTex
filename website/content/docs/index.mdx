---
title: Introduction
description: Schematex compiles plain text into standards-compliant SVG diagrams. 13+ diagram types across relationship, electrical, and business domains.
---
...
- [Playground](/playground) — try all 13 diagram types live
